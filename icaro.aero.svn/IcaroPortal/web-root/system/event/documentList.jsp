				...
				<tr>
					<td>
						...
						<table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								<td>
										<html:form action="/system/event/document">
						...
						<table width="95%">
							<tr>
								<td align="center">
									<html:button property="button" style="font-size: 9px; height: 18px;" styleClass="button" onclick="openAll('event')" onmouseover="swapClass(this, 'button', 'buttonhi')" onmouseout="swapClass(this, 'button', 'buttonhi')">
						...
						<table align="center" class="list" border="0" cellpadding="2" cellspacing="1" width="95%">
							...
							<!--Fin Header-->
								<c:forEach var="item" items="${documentList}" varStatus="status">	
									<c:url value="/system/event/document.do" var="urlRead">
