...
<html:form action="/system/jobs/position">
...
<table cellpadding="0" cellspacing="0" border="0" width="97%">
	...
	<!--inicio listado-->
		...
		<tr>
			...
			<c:forEach var="item" items="${positionList}" varStatus="status">
				<c:url value="/system/jobs/position.do" var="urlRead">
	...
	<tr>
	<td><!--<a href="javascript: doAction(document.positionForm, 'action', 'create')"><img alt="<bean:message key="button.add" bundle="messages" />" src="${pageContext.request.contextPath}/images/icons/add_new.gif" width="16" height="16" border="0" alt=""><bean:message key="button.add" bundle="messages" /></a>--></td>
	</tr>
