	...
	<tr>
		<td class="title" width="300">		
			<c:choose>
				...
				<c:otherwise>
						<bean:message key="service.faq" bundle="systemMenu" /> - <bean:message key="information.related.documents" bundle="systemMenu" />
					<c:set var="systemMenuLabel" ><bean:message key="information.related.documents" bundle="systemMenu" /></c:set>
				</c:otherwise>
			</c:choose>
		</td>
		<td align="right">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="subtitle">
					...
					<bean:message key="service.faq" bundle="systemMenu" />:${faqName}
...
<tr>
	<td>
		<tiles:insert definition="tabs.system.faq">
			<tiles:put name="code" value="${faqCode}" />
				...
				<tr>
					<td>
						...
						<table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								<td>
									<html:form action="/system/faq/document">
						...
						<table width="95%">
							<tr>
								<td align="center">
									<html:button property="button" style="font-size: 9px; height: 18px;" styleClass="button" onclick="openAll('faq')" onmouseover="swapClass(this, 'button', 'buttonhi')" onmouseout="swapClass(this, 'button', 'buttonhi')">
						...
						<table align="center" class="list" border="0" cellpadding="2" cellspacing="1" width="95%">
							<tr>
							  ...
							  <%--	<th width="50"><bean:message key="label.documentType" bundle="messages" /></th>--%>
							...
							<c:forEach var="item" items="${documentList}" varStatus="status">	
								<c:url value="/system/faq/document.do" var="urlRead">
								...
								<tr class="item" onMouseOver="swapClass(this, 'item', 'itemhi')" onMouseOut="swapClass(this, 'item', 'itemhi')">
									...
									<%--<td>
										<c:if test="${!empty item.path}">
											<img src="${pageContext.request.contextPath}${item.pathIcon}" border="0" alt="${item.path}">
										</c:if>
									</td>--%>
									<td>
										<c:choose>
									...
									<td>
										<c:if test="${!empty item.path}">
										<a href="${pageContext.request.contextPath}${item.path}" target="_blank">	<img src="${pageContext.request.contextPath}${item.pathIcon}" border="0" alt="${item.path}">
										</a>
										</c:if>
									</td>
								</tr>
