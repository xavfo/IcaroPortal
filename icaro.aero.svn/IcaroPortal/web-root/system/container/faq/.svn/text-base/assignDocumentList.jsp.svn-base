		...
		<td class="title" width="400">			
			<c:choose>
				<c:when test="${param.docTypeCode eq initParameters.DOCUMENT_TYPE_DOCUMENTS}">
					<bean:message key="service.faq" bundle="systemMenu" /> - <bean:message key="document.document" bundle="systemMenu" />
					<c:set var="systemMenuLabel" ><bean:message key="document.document" bundle="systemMenu" /></c:set>
				</c:when>
				<c:otherwise>
					<bean:message key="service.faq" bundle="systemMenu" /> - <bean:message key="information.selection.documents" bundle="systemMenu" />
				...
				<tr>
					<td>
						...
						<table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								<td>
									<html:form action="/system/faq/assign/document">
						...
						<html:form action="/system/faq/assign/document/save" >
