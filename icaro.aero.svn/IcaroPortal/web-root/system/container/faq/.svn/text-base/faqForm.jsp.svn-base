...
<tr>
	<td>
		<tiles:insert definition="tabs.system.faq">
			<tiles:put name="code" value="${faqContainerForm.code}" />
			<tiles:put name="tab" value="1" />
...
<tr>
	<td>
		<html:form action="/system/container/faq/save" focus="question" onsubmit="return preValidate(this)">
