...
<html:form action="/system/portal/generalSearch/list" focus="name">
...
<table align="center" class="list" border="0" cellpadding="2" cellspacing="1" width="95%">
	<tr>
		<th width="30">#</th>
		<th width="150"><bean:message key="label.title" bundle="messages" /></th>
<%--		<th width="110"><bean:message key="prompt.enabled" /></th>--%>
	...
	<c:forEach var="item" items="${resultList}" varStatus="status">		
		<tr class="item" onMouseOver="swapClass(this, 'item', 'itemhi')" onMouseOut="swapClass(this, 'item', 'itemhi')">
			...
			<td><a href="javascript:setValues(${item.code}, '${item.name}');">${item.name}</a></td>
			<%--<td align="center">
				<c:choose>
	...
	<tr>
		<td>
			<tiles:insert definition="system.pager">
				...
				<tiles:put name="totalPages" value="${generalSearchForm.totalPages}" />
				<tiles:put name="currentPage" value="${generalSearchForm.pageNumber}" />
