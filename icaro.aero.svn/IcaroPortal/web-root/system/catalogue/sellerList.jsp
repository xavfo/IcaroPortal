...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="title" width="300"><bean:message key="cart.seller" bundle="systemMenu" /></td>
		<td align="right">
...
<table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td>
			<html:form action="/system/catalogue/seller">
					...
					<td width="100%" bgcolor="#EBEEF3">
						...
						<table border="0" cellpadding="0" cellspacing="2" width="100%">
							<tr>
								...
								<td width="130">
									<bean:message key="label.ruc" bundle="messages" /><br>
									<html:text property="ruc" styleClass="input" style="width: 120px;" maxlength="100" />
								</td>
								<td width="120">
...
<table align="center" class="list" border="0" cellpadding="2" cellspacing="1" width="95%">
	...
	<c:if test="${empty requestScope.sellerList && sellerForm.listItems }">
		<tr>
			<td height="20" align="center" colspan="5" class="message"><bean:message key="message.empty.records" /></td>
		</tr>	
	</c:if>  
