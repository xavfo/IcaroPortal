...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="title" width="300"><bean:message key="cart.office" bundle="systemMenu" /></td>
		<td align="right">
...
<table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td>
			<html:form action="/system/catalogue/office">
...
<table align="center" class="list" border="0" cellpadding="2" cellspacing="1" width="95%">
	<tr>
	  ...
	  <th width="382"><bean:message key="label.type" bundle="messages" /></th>
	...
	<c:forEach var="item" items="${officeList}" varStatus="status">	
		<c:url value="/system/catalogue/office.do" var="urlRead">
	...
	<c:if test="${empty requestScope.officeList && officeForm.listItems }">
		<tr>
