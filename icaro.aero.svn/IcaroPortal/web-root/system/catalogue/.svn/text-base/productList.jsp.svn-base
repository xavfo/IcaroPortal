...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="title" width="300"><bean:message key="cart.product" bundle="systemMenu" /></td>
		<td align="right">
...
<table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td>
			<html:form action="/system/catalogue/product">
						...
						<tr>
							...
							<td>
								<html:select property="orderField" size="1" styleClass="input" style="width: 110px;" onchange="submitOrder(this)">
									...
									<html:option value="stock"><bean:message key="label.stock" bundle="messages" /></html:option>
									<html:option value="minStock"><bean:message key="label.stockMin" bundle="messages" /></html:option>
									<html:option value="maxStock"><bean:message key="label.stockMax" bundle="messages" /></html:option>
...
<table align="center" class="list" border="0" cellpadding="2" cellspacing="1" width="95%">
	<tr>
		...
		<th width="50"><bean:message key="label.stock" bundle="messages" /></th>
		<th width="50"><bean:message key="label.stockMin" bundle="messages" /></th>
		<th width="50"><bean:message key="label.stockMax" bundle="messages" /></th>
		<th width="80"><bean:message key="label.enabled" bundle="messages" /></th>
	</tr>
	<c:forEach var="item" items="${productList}" varStatus="status">	
		<c:url value="/system/catalogue/product.do" var="urlRead">
	...
	<c:if test="${empty requestScope.productList && productForm.listItems }">
		<tr>
			<td height="20" align="center" colspan="11" class="message"><bean:message key="message.empty.records" /></td>
		</tr>	
	</c:if>  
	
</table>
</html:form>
<c:remove var="productForm" />