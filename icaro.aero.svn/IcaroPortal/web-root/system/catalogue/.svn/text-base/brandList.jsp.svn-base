...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="title" width="300"><bean:message key="cart.brand" bundle="systemMenu" /></td>
		<td align="right">
...
<table align="center" class="list" border="0" cellpadding="2" cellspacing="1" width="95%">
	...
	<c:if test="${empty requestScope.brandList && brandForm.listItems }">
		<tr>
			<td height="20" align="center" colspan="3" class="message"><bean:message key="message.empty.records" /></td>
		</tr>	
	</c:if>  
