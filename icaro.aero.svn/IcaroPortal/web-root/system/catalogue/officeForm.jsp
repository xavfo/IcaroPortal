...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="title" width="300">
			<bean:message key="cart.office" bundle="systemMenu" />
			<c:set var="systemMenuLabel" ><bean:message key="cart.office" bundle="systemMenu" /></c:set>
		</td>
		<td align="right">
...
<html:form action="/system/catalogue/office/save" focus="name" onsubmit="return preValidate(this)">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="subtitle">
			<c:choose>
				<c:when test="${!empty officeForm.code && officeForm.code != 0}">
					<bean:message key="message.edit" bundle="systemHelp" arg0="${officeForm.name}" />
				</c:when>
				<c:otherwise>
...
<table class="form" align="right" border="0" cellpadding="4" cellspacing="0" width="95%">
	...
	<tr>
		<td class="required">* <bean:message key="prompt.phone" /> :</td>
		<td><html:text property="phone" styleClass="input" style="width: 100px;" /></td>
	</tr>		
	<tr>
	...
	<html:select property="typeCode" size="1" styleClass="input" style="width: 250px;"  >
		...
		<c:if test="${!empty officeTypeList}">
			<html:options collection="officeTypeList" property="code" labelProperty="name"/>
		</c:if>
	</html:select>
		</span>
			</td>
	...
	<tr>
		...
		<td>
			...
			<a href="javascript: openUploadWindow('/popup/openUpload.do', '/images/uploaded/office', 'officeForm', 'image','office_image','${initParameters.SEQ_OFFICE_IMAGE}',0)";"  onMouseOver="MM_swapImage('uploadImg','','${pageContext.request.contextPath}/images/icons/upload_roll.gif',1)" onMouseOut="MM_swapImgRestore()">
			...
			<a href="javascript:openPreview('/popup/openPreview.do', officeForm.image.value)"  onMouseOver="MM_swapImage('previewImg','','${pageContext.request.contextPath}/images/icons/preview_roll.gif',1)" onMouseOut="MM_swapImgRestore()">
...
<html:javascript formName="officeForm" dynamicJavascript="true" staticJavascript="false" />
