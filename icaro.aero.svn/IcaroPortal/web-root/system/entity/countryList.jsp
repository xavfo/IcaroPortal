...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="title" width="300"><bean:message key="information.country" bundle="systemMenu" /></td>
		<td align="right">
...
<table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td>
			<html:form action="/system/information/country">
...
<table align="center" class="list" border="0" cellpadding="2" cellspacing="1" width="95%">
	<tr>
	  ...
	  <th width="162"><bean:message key="label.iso" bundle="messages" /></th>
		<%--<th width="100"><bean:message key="label.key" bundle="messages" /></th>--%>
