...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="title" width="300"><bean:message key="icaro.flight.route" bundle="systemMenu" /></td>
		<td align="right">
			<bean:message key="icaro" bundle="systemMenu" /> &gt;
			<bean:message key="icaro.flight" bundle="systemMenu" /> &gt;
			<bean:message key="icaro.flight.route" bundle="systemMenu" />
		</td>
	</tr>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td>
			<bean:message key="dialog.icaro.flight.route" bundle="systemHelp" />
			<ul>
...
<table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td>
			<html:form action="/system/portal/route">
						...
						<tr>
							...
							<td>
								<html:select property="orderField" size="1" styleClass="input" style="width: 110px;" onchange="submitOrder(this)">
									...
									<html:option value="enabled"><bean:message key="label.enabled" bundle="messages" /></html:option>
								</html:select>	
							</td>
							<td><img src="${pageContext.request.contextPath}/images/shim.gif" width="5" height="15" ></td>
							<td>
...
<table class="list" border="0" cellpadding="2" cellspacing="1" width="100%">
	...
	<c:forEach var="item" items="${routeList}" varStatus="status">		
		<c:url value="/system/portal/route.do" var="urlRead">
	...
	<c:if test="${empty requestScope.routeList && routeForm.listItems }">
		<tr>
