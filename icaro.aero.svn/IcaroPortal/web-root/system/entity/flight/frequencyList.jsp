				...
				<tr>
					<td>
						...
						<table cellpadding="0" cellspacing="0" align="center"  width="100%">
							<tr>
								<td>
								  	<html:form action="/system/portal/route/frequency">	
									...
									<html:hidden property="subTab" value="1" />
									<table cellpadding="0" cellspacing="0" border="0" width="100%">
										<tr>
										<td valign="top">
										<!--inicio listado-->
											...
											<tr>
										        ...
										        <tr>
													...
													<th width="120"><bean:message key="label.name" bundle="messages" /></th>
												...
												<c:forEach var="item" items="${frequencyList}" varStatus="status">
													<c:url value="/system/portal/route/frequency.do" var="urlRead">
														<c:param name="action" value="read" />
														<c:param name="code" value="${item.code}" />
														<c:param name="tab" value="${param.tab}" />
														<c:param name="subTab" value="1" />
													</c:url> 	
												...
												<c:if test="${empty frequencyList }">
													<tr>
														<td height="20" align="center" colspan="7" class="message">No hay frecuencias registradas para la ruta ${routeForm.name}</td>
													</tr>	
												</c:if>  
