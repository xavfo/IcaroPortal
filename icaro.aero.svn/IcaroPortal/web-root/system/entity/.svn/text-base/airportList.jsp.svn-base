...
<table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td>
			<html:form action="/system/information/airport">
			...
			<table cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					...
					<td width="130" valign="middle">
									<bean:message key="label.iataCode" bundle="messages" /><br>
									<html:text property="iataCode" styleClass="input" style="width: 120px;" maxlength="100" />
								</td>
					<td valign="bottom">
...
<table align="center" class="list" border="0" cellpadding="2" cellspacing="1" width="95%">
	<tr>
	  ...
	  <th width="382"><bean:message key="label.iataCode" bundle="messages" /></th>
	  <th width="80"><bean:message key="label.enabled" bundle="messages" /></th>
	</tr>
	<c:forEach var="item" items="${airportList}" varStatus="status">	
		<c:url value="/system/information/airport.do" var="urlRead">
		...
		<tr class="item" onMouseOver="swapClass(this, 'item', 'itemhi')" onMouseOut="swapClass(this, 'item', 'itemhi')">
			...
			<td><a href="${urlRead}" class="item">${item.city.name}</a></td>
			<td><a href="${urlRead}" class="item">${item.iataCode}</a></td>
			<td>
				<c:choose>
	...
	<c:if test="${empty requestScope.airportList && airportForm.listItems }">
		<tr>
