...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="title" width="300"><bean:message key="news.news" bundle="systemMenu" /></td>
		<td align="right">
...
<table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td>
			<html:form action="/system/news/news">
						...
						<table border="0" cellpadding="0" cellspacing="2" width="100%">
							<tr>
								...
								<td width="120">
									...
									<html:select property="localInfoOption" size="1" styleClass="input" style="width: 110px;">
										<html:option value="-1"><bean:message key="option.all" bundle="messages" /></html:option>
										<html:option value="1"><bean:message key="label.internal" bundle="messages" /></html:option>
										<html:option value="0"><bean:message key="label.external" bundle="messages" /></html:option>
									</html:select>
								</td>		
								<td>									
						...
						<tr>
							...
							<td>
								<html:select property="orderField" size="1" styleClass="input" style="width: 110px;" onchange="submitOrder(this)">
									...
									<html:option value="isLocalInfo"><bean:message key="label.type" bundle="messages" /></html:option>
...
<table align="center" class="list" border="0" cellpadding="2" cellspacing="1" width="95%">
	...
	<c:forEach var="item" items="${newsList}" varStatus="status">
		<c:url value="/system/news/news.do" var="urlRead">
	...
	<tr class="item" onMouseOver="swapClass(this, 'item', 'itemhi')" onMouseOut="swapClass(this, 'item', 'itemhi')">
		...
		<td style="padding-left:5px">
			<c:choose>
				<c:when test="${item.isLocalInfo == true}">
					<bean:message key="label.internal" bundle="messages" />
				</c:when>
				<c:otherwise>
					<bean:message key="label.external" bundle="messages" />
				</c:otherwise>
			</c:choose>
		</td>	
		<td style="padding-left:5px">
