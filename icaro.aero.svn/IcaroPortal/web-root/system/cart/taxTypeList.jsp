...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td class="title" width="300"><bean:message key="cart.taxType" bundle="systemMenu" /></td>
    <td align="right"><bean:message key="cart" bundle="systemMenu" /> &lt; <bean:message key="cart.taxType"
...
<%--  table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td>
			<html:form action="/system/cart/taxType">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td><tiles:insert definition="tabs.system.taxType">
      <tiles:put name="code" value="${taxTypeForm.code}" />
      <tiles:put name="tab" value="${tab}" />
    </tiles:insert></td>
  </tr>
  <tr>
    <td><html:form action="/system/cart/taxType">
        ...
        <tr>
          ...
          <table align="center" class="list" border="0" cellpadding="2" cellspacing="1" width="95%">
            <tr>
              ...
              <%--  th width="20%"><bean:message key="label.code" bundle="messages" /></th --%>
              <th width="40%"><bean:message key="label.taxType" bundle="messages" /></th>
              <th width="50%"><bean:message key="label.taxes" bundle="messages" /></th>
            </tr>
            <c:forEach var="item" items="${taxTypeList}" varStatus="status">
              <c:url value="/system/cart/taxType.do" var="urlRead">
              ...
              <tr class="item" onMouseOver="swapClass(this, 'item', 'itemhi')"
                ...
                <%-- td><fmt:formatNumber value="${item.code}" pattern="#00000000" /></td --%>
                <td><a href="${urlRead}" class="item">${item.name}</a></td>
                <td><c:forEach var="tax" items="${item.taxes}">	
					 ${tax.name} (<fmt:formatNumber value="${tax.currentRate}" pattern="#.0%" />)&nbsp;
				  </c:forEach></td>
              </tr>
            </c:forEach>
          </table>
