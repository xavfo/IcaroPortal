				...
				<tr>
					<td>
						...
						<table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								<td>
									<html:form action="/system/portal/content/link">
												...
												<table border="0" cellpadding="0" cellspacing="2" width="100%">
													<tr>
														...
														<td width="130">
															...
															<html:select property="typeCode" size="1" styleClass="input" style="width: 120px;">
																<html:option value="0"><bean:message key="option.all" bundle="messages"/></html:option>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								<td align="center">
									...
									<bean:message key="information.selection.link" bundle="systemMenu" /></html:button>
								</td>
							</tr>
						</table>
						...
						<table align="center" class="list" border="0" cellpadding="2" cellspacing="1" width="95%">
							...
							<c:forEach var="item" items="${linkList}" varStatus="status">	
								<c:url value="/system/portal/content/link.do" var="urlRead">
