...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="title" width="55%">
			${currentContent.name} -
			<bean:message key="portal.sri.statistic.select" bundle="systemMenu" />
		</td>
		<td align="right">
					...
					<td>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="98%">
							<tr>
								...
								<td width="700">
									<c:url var="urlList" value="/system/portal/content/statistics.do">
						...
						<table align="center" class="list" border="0" cellpadding="2" cellspacing="1" width="95%">
							...
							<!--Fin Header-->
							<c:forEach var="item" items="${unboundStatisticList}" varStatus="status">	
