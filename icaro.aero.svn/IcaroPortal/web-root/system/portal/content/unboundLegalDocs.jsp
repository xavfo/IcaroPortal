...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="title" width="65%">
			${currentContent.name} -
			<bean:message key="portal.sri.legal.select" bundle="systemMenu"/>
		</td>
		<td align="right">
				...
				<tr>
					<td>
						...
						<table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								<td>
									<html:form action="/system/portal/content/legalDoc">
												...
												<tr>
													...
													<td>
														<html:select property="orderField" size="1" styleClass="input" style="width: 110px;" onchange="submitOrder(this)">
															...
															<html:option value="category.name"><bean:message key="label.type" bundle="messages" /></html:option>									
														</html:select>				
													</td>
													<td><img src="${pageContext.request.contextPath}/images/shim.gif" width="5" height="15" ></td>
													<td>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								...
								<td width="700">
									<c:url var="urlList" value="/system/portal/content/legalDoc.do">
						...
						<table align="center" class="list" border="0" cellpadding="2" cellspacing="1" width="95%">
							<tr>
								...
								<th width="30"><input type="checkbox" name="checkAll" onClick="setCheckBoxValue(this.form, 'codes', this.checked)"></th>
					  			...
					  			<th width="200" align="center"><bean:message key="label.category" bundle="messages" /></th>				
							  	<th width="80"><bean:message key="label.status" bundle="messages" /></th>
							</tr>
							<!--Fin Header-->
							<c:forEach var="item" items="${unboundLegalDocList}" varStatus="status">	
								<tr class="item" onMouseOver="swapClass(this, 'item', 'itemhi')" onMouseOut="swapClass(this, 'item', 'itemhi')">
									...
									<td align="center">
										<table border="0" width="98%">
											<c:forEach var="theme" items="${item.categories}">
												<tr>
													<td>${theme.name}</td>
												</tr>	
											</c:forEach>
									...
									<td>
										<c:choose>
											...
											<c:otherwise>
												<bean:message key="label.disabled" bundle="messages" />
											</c:otherwise>
										</c:choose>
									</td>
