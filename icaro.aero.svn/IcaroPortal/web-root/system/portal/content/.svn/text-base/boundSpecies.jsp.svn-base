...
<script>
	function openAll(){
		location.href='<%=request.getContextPath()%>/system/portal/content/species.do?action=listUnbound&itemCode=${currentContent.code}'
	}
</script>
				...
				<tr>
					<td>
						...
						<table align="center" class="list" border="0" cellpadding="2" cellspacing="1" width="95%">
							...
							<!--Fin Header-->
							<c:forEach var="item" items="${boundSpeciesList}" varStatus="status">	
