...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="title" width="300"><bean:message key="information.state" bundle="systemMenu" /></td>
		<td align="right">
			<bean:message key="information" bundle="systemMenu" /> &lt;
			<bean:message key="information.state" bundle="systemMenu" />
		</td>
	</tr>
</table>
...
<table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td>
			<html:form action="/system/portal/state">
						...
						<table border="0" cellpadding="0" cellspacing="2" width="100%">
							<tr>
								...
								<td width="160">
									...
									<html:select property="countryCode" size="1" styleClass="input" style="width: 150px;">
...
<table class="list" border="0" cellpadding="2" cellspacing="1" width="100%">
	<tr>
		...
		<th width="250"><bean:message key="label.country" bundle="messages" /></th>
		<th><bean:message key="label.enabled" bundle="messages" /></th>
	</tr>
	<c:forEach var="item" items="${stateList}" varStatus="status">
		<c:url value="/system/portal/state.do" var="urlRead">
