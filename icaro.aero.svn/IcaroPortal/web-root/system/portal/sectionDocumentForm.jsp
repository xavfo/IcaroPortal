...
<c:url value="/system/portal/sectionDocument.do" var="urlBack">
	<c:param name="action" value="list" />
	<c:param name="sectionCode" value="${section.code}" />
</c:url>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
...
<html:form action="/system/portal/sectionDocument/save" focus="name" onsubmit="return validateDocumentForm(this);">
