...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/fckeditor/editor/js/fckeditorcode_ie.js"></script>
...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="100%">
	<tr>
		<td >
		    <!-- Container TABS -->
			<tiles:insert definition="tabs.system.content.2">
					<tiles:put name="code" value="${categoryForm.code}" />
			</tiles:insert>
			<!-- END Container TABS -->
		</td>
	</tr>
	<tr>
		<td>
			...
			<html:form action="/system/portal/category/save" focus="title" onsubmit="return validateCategoryForm(this);" >
					...
					<td>
						<table border="0" cellpadding="4" cellspacing="0" width="100%">
							<tr>
								<td class="subtitle">
									<c:choose>
										<c:when test="${!empty categoryForm.code && categoryForm.code != 0}">
											<bean:message key="message.edit" bundle="systemHelp" arg0="${categoryForm.title}" />
										</c:when>
										<c:otherwise>
							...
							<table class="form" align="right" border="0" cellpadding="4" cellspacing="0" width="100%">
								...
								<tr>
									<td class="required">* <bean:message key="prompt.section" /> :</td>
									<td>
								...
								<tr>
									...
									<td>
										...
										<iframe name="intro___Frame" id="intro___Frame" src="${pageContext.request.contextPath}/js/fckeditor/editor/fckeditor.html?InstanceName=intro" width="100%" height="200" frameborder="0" scrolling="no"></iframe>
									</td>
								</tr>
																				<tr>
								...
								<%--tr>
									...
									<td>
										...
										<iframe name="text___Frame" id="text___Frame" src="${pageContext.request.contextPath}/js/fckeditor/editor/fckeditor.html?InstanceName=text" width="100%" height="200" frameborder="0" scrolling="no"></iframe>
																			</td>
								</tr--%>
								<tr>
								...
								<tr>
									...
									<td>
										...
										<a href="javascript: openUploadMediaWindow('/popup/openUploadMediaFile.do', '/content', 'categoryForm', 0, ${initParameters.MEDIA_TYPE_IMAGE},
																		  'imageCode', 'imageName');" >
											<img src="${pageContext.request.contextPath}/images/system/icons/upload.gif" border="0"/>
										</a>
...
<html:javascript formName="categoryForm" dynamicJavascript="true" staticJavascript="false" />
...
<c:if test = "${!empty categoryForm.layoutCode && categoryForm.layoutCode != 0}">
	<c:set var="targetLayout">${categoryForm.layoutCode}</c:set>	
</c:if>
