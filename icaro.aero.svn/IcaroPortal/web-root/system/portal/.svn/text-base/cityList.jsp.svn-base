...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="title" width="300"><bean:message key="information.city" bundle="systemMenu" /></td>
		<td align="right">
...
<table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td>
			<html:form action="/system/portal/city">
						...
						<tr>
							...
							<td>
								<html:select property="orderField" size="1" styleClass="input" style="width: 110px;" onchange="submitOrder(this)">
									...
									<html:option value="state.country.name"><bean:message key="label.country" bundle="messages" /></html:option>
									<html:option value="state.name"><bean:message key="label.state" bundle="messages" /></html:option>
...
<table class="list" border="0" cellpadding="2" cellspacing="1" width="100%">
	<tr>
		...
		<th width="100"><bean:message key="prompt.homeDelivery"  /></th>
	</tr>
	<c:forEach var="item" items="${cityList}" varStatus="status">		
		<c:url value="/system/portal/city.do" var="urlRead">
		...
		<tr class="item" onMouseOver="swapClass(this, 'item', 'itemhi')" onMouseOut="swapClass(this, 'item', 'itemhi')">
			...
			<td>
				<c:choose>
						<c:when test="${item.homeDelivery == true}">
							<bean:message key="label.yes" bundle="messages" />
						</c:when>
						<c:otherwise>
							<bean:message key="label.no" bundle="messages" />
