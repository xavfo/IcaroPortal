...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="title" width="300"><bean:message key="portal.access" bundle="systemMenu" /></td>
		<td align="right">
...
<table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td>
			<html:form action="/system/portal/access">
				...
				<tr>
					...
					<td width="100%" bgcolor="#EBEEF3">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr><td class="subtitle">&nbsp;<img src="../../images/icons/find.gif" width="16" height="16" border="0" alt=""> <bean:message key="label.search" bundle="messages" /></td></tr>
						</table>
						<table border="0" cellpadding="0" cellspacing="2" width="100%">
							<tr>
								...
								<%--td width="160">
									<bean:message key="label.bannerType" bundle="messages" /><br>
									<html:select property="accessTypeCode" size="1" styleClass="input" style="width: 150px;">
						...
						<tr>
							...
							<td>
								<html:select property="orderField" size="1" styleClass="input" style="width: 110px;" onchange="submitOrder(this)">
									...
									<html:option value="accessType.name"><bean:message key="label.bannerType" bundle="messages" /></html:option>
								</html:select>				
							</td>
							<td><img src="${pageContext.request.contextPath}/images/shim.gif" width="5" height="15" ></td>
							<td>
...
<table class="list" border="0" cellpadding="2" cellspacing="1" width="100%">
	<tr>
		...
		<!-- th width="250"><bean:message key="label.bannerType" bundle="messages" /></th -->
	</tr>
	<c:forEach var="item" items="${accessList}" varStatus="status">
		<c:url value="/system/portal/access.do" var="urlRead">
