		...
		<td class="title" nowrap="nowrap">
			...
			<c:choose>
				<c:when test="${documentContainerForm.docTypeCode eq initParameters.DOCUMENT_TYPE_DOCUMENTS}">
					<bean:message key="document.document" bundle="systemMenu" /><br />
					<span class="subtitle"><bean:message key="information.selection.documents" bundle="systemMenu" /></span>
				...
				<c:otherwise>
					...
					<span class="subtitle"><bean:message key="information.selection.support" bundle="systemMenu" /></span><br />
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td>
						...
						<html:form action="/system/portal/content/document" >
						<html:hidden property="action" value="assign" />
						<html:hidden property="itemCode" value="${currentContent.code}" />
						<html:hidden property="docTypeCode" />
						<html:hidden property="tab" value="${param.tab}"  />
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
