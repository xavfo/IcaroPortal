...
<table border="0" cellpadding="0" cellspacing="0" align="center" width="100%">
	...
	<tr>
		<td>
			<html:form action="/system/portal/menu/item">
						...
						<table class="list" border="0" cellpadding="2" cellspacing="1" width="100%">
							<tr>
								<th align="left">
									...
									<bean:message key="label.menuItem" bundle="messages" />
								</th>
								<th><bean:message key="label.enabled" bundle="messages" /></th>
							</tr>
							<c:forEach var="item" items="${menuItemList}" varStatus="status">
								<c:url value="/system/portal/menu/item.do" var="urlRead">
