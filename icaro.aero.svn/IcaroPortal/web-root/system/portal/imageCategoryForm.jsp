...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="title" width="300">
			...
			<c:set var="systemMenuLabel" ><bean:message key="information.catalogues.imageCategory" bundle="systemMenu" /></c:set>
		</td>
		<td align="right">
...
<html:form action="/system/information/imageCategory/save" focus="name" onsubmit="return preValidate(this)">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="subtitle">
			<c:choose>
				<c:when test="${!empty imageCategoryForm.code && imageCategoryForm.code != 0}">
					<bean:message key="message.edit" bundle="systemHelp" arg0="${imageCategoryForm.name}" />
				</c:when>
				<c:otherwise>
...
<html:javascript formName="imageCategoryForm" dynamicJavascript="true" staticJavascript="false" />
...
<script language="JavaScript1.2">
	function preValidate (frm) { 
	  ...
	  if( confirm (msg)){
		  return validateImageCategoryForm(frm);
	  } else { return false; }
	}
</script>
