...
<c:url value="/system/service/faqCategory.do" var="urlAdd">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="title" width="300"><bean:message key="service.faqCategory" bundle="systemMenu" /></td>
		<td align="right">
			<bean:message key="service" bundle="systemMenu" /> >
			<bean:message key="service.faqCategory" bundle="systemMenu" />
		</td>
	</tr>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td>
			<bean:message key="dialog.service.faqCategory" bundle="systemHelp" />
