...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="title" width="300"><bean:message key="service.link" bundle="systemMenu" /></td>
		<td align="right">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td>
			<bean:message key="dialog.service.link" bundle="systemHelp" />
			<html:messages id="message" message="true">
				<div class="message"><c:out value="${message}" escapeXml="false" /></div>
			</html:messages>
		</td>
		<td align="right">
			<c:url value="/system/service/link.do" var="urlBack">
				<c:param name="action" value="list" />
			</c:url>
			<a href="${urlBack}" class="back"><bean:message key="label.listAll" bundle="messages" /> <bean:message key="service.link" bundle="systemMenu" /></a>
		</td>			
	</tr>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="subtitle">
			<c:choose>
				<c:when test="${!empty linkForm.code && linkForm.code != 0}">
					<bean:message key="message.edit" bundle="systemHelp" arg0="${linkForm.name}" />
				</c:when>
				<c:otherwise>
...
<html:form action="/system/service/link/save" focus="name" onsubmit="return validateLinkForm(this);">
...
<html:javascript formName="linkForm" dynamicJavascript="true" staticJavascript="false" />
