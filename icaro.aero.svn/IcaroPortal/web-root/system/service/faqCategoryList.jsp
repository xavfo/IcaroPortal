...
<html:form action="/system/service/faqCategory" target="iform">
	...
	<tr>
		<td>
			...
			<!--
				...
				tree.add(0,-1,'<bean:message key="service.faqCategory" bundle="systemMenu" /> (${appLanguage.name})');
					
				<c:forEach var="item" items="${faqCategoryList}" varStatus="status">
			       	<c:url value="/system/service/faqCategory.do" var="urlRead">
