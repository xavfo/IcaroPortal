...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td class="subtitle">
			<c:choose>
				<c:when test="${!empty linkCategoryForm.code && linkCategoryForm.code != 0}">
					<bean:message key="message.edit" bundle="systemHelp" arg0="${linkCategoryForm.name}" />
				</c:when>
				<c:otherwise>
...
<html:form action="/system/service/linkCategory/save" focus="name" onsubmit="return validateLinkCategoryForm(this);">
...
<html:javascript formName="linkCategoryForm" dynamicJavascript="true" staticJavascript="false" />
