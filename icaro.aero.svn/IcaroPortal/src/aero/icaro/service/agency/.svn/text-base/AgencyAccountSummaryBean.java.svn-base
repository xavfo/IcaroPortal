 ...
 * @see aero.icaro.service.agency.stub.AgencyAccountSummary
 * 
 */
public class AgencyAccountSummaryBean extends IcaroServiceMessageBean {
	...
	public AgencyAccountSummaryBean() {
		super();
		this.clear();
	}
	 ...
	 * @param response
	 */
	public AgencyAccountSummaryBean(BigInteger statusCode, String response) {
