...
import aero.icaro.service.corp.stub.CorpAccountSummary;
import aero.icaro.service.corp.stub.CorpServiceLocator;
import aero.icaro.service.corp.stub.CorpServicePortType;
import aero.icaro.service.corp.stub.IcaroUser;
import aero.icaro.service.corp.stub.MilleDetail;
import aero.icaro.service.IcaroUserBean;
import aero.icaro.service.MillesDetailBean;
import aero.icaro.service.corp.stub.IcaroServiceMessage;
 ...
 */
public class CorpServiceManager extends IcaroServiceManager {

    private static Log logger = LogFactory.getLog(CorpServiceManager.class);

    private CorpServicePortType corp;
     ...
     */
    public CorpServiceManager() throws ServiceException {
        super();
        this.clear();
        this.reset();
    }
     ...
     */
    public CorpServiceManager(Object module) throws ServiceException {
        super(module);
        this.clear();
        this.reset();
     ...
     * @throws ServiceException
     */
    public CorpServiceManager(Object module, HttpServletRequest request)
            throws ServiceException {
    ...
    protected void reset() throws ServiceException {
        CorpServiceLocator locator = new CorpServiceLocator();
        String address = StringUtils.replaceOnce(locator
                .getCorpServicePortAddress(), "icaro.aero/serviciosweb/",
        ...
        locator.setCorpServicePortEndpointAddress(address);
        this.endPointAddress = " Endpoint: ".concat(address);
        // logger.info(address);
        this.setService(locator);
        corp = locator.getCorpServicePort();
    }
    ...
    protected CorpAccountSummaryBean getCorpAccountSummaryBean(
            CorpAccountSummary bean) {
        CorpAccountSummaryBean accountBean = null;
        if (bean != null) {
            accountBean = new CorpAccountSummaryBean();
            // Datos Llamada a WebService
    ...
    public IcaroUserBean corpLogin(String cardNumber, String password)
            throws IcaroServiceException {

        IcaroUserBean resp = null;
        String methodCalled = "corpLogin";
        if (corp == null) {
            throw new IcaroServiceException(BaseHelper
                    .getApplicationBundleMessage(
                            "error.webService.client.interface", new String[] {
                                    CorpServicePortType.class.toString(),
                                    CorpServiceLocator.class.toString() }));
        }

        try {
            // invocar al servicio
            IcaroUser result = this.corp.corpLogin(cardNumber, password);
    ...
    public CorpAccountSummaryBean getCorpAccountSummary(String cardNumber)
            throws IcaroServiceException {

        CorpAccountSummaryBean resp = null;
        String methodCalled = "getCorpAccountSummary";
        if (corp == null) {
            throw new IcaroServiceException(BaseHelper
                    .getApplicationBundleMessage(
                            "error.webService.client.interface", new String[] {
        ...
        try {
            ...
            // invocar al servicio
            CorpAccountSummary result = this.corp
                    .getCorpAccountSummary(cardNumber);
            // convertir a userBean
            resp = this.getCorpAccountSummaryBean(result);
                ...
                IcaroServiceMessageBean message = new IcaroServiceMessageBean(
                        Constants.FALSE_BIG_INT, BaseHelper
                                .getApplicationBundleMessage(
                                        "error.webService.client.callFailed",
                                        arguments));
                resp = new CorpAccountSummaryBean(Constants.FALSE_BIG_INT,
                        message.getResponse());
            }
        } finally {
            // auditar servicio
    ...
    public IcaroServiceMessageBean getCorpAccountDetail(String cardNumber)
            throws IcaroServiceException {
        ...
        try {
            ...
            // invocar al servicio
            IcaroServiceMessage result = this.corp
                    .getCorpAccountDetail(cardNumber);
            // convertir a userBean
    ...
    public IcaroServiceMessageBean updateCorpAccount(ServiceAccountForm form)
            throws IcaroServiceException {
        ...
        try {
            ...
            // invocar al servicio
            IcaroServiceMessage result = this.corp.updateCorpAccount(form
    ...
    public static void main(String[] args) {
        try {
            ...
            CorpServiceManager manager = new CorpServiceManager();
            IcaroUserBean client=null;
            client = manager.corpLogin("5450512470","5405");
