 ...
 * @see aero.icaro.service.skies.stub.SkiesAccountSummary
 * 
 */
public class SkiesAccountSummaryBean extends IcaroServiceMessageBean {
	...
	public SkiesAccountSummaryBean() {
		super();
		this.clear();
	}
	 ...
	 * @param response
	 */
	public SkiesAccountSummaryBean(BigInteger statusCode, String response) {
