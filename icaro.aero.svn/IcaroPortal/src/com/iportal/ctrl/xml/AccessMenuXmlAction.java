 ...
 * asi las actualizaciones son automaticas
 * 
 * @author YAGE(hernan)
 *
 */
public class AccessMenuXmlAction extends BaseDispatchAction {

	private static Log logger = LogFactory.getLog(AccessMenuXmlAction.class);
...
//     	        	 hql.append(" CASE WHEN accessItem.access.accessUrl.code != 1 THEN false  ELSE true END, ");
     	        	 hql.append(" accessItem.access.path, accessItem.menuLanguage.menu.code, accessItem.menuLanguage.name ) ");
		...
		String forward=Globals.FORWARD_SUCCESS+"_menu";
